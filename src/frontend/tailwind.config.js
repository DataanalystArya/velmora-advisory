  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        vgrey: {
          light: "oklch(var(--grey-light))",
          mid: "oklch(var(--grey-mid))",
        },
      },
      fontFamily: {
        ...
        plusJakarta: ["'Plus Jakarta Sans'", "system-ui", "-apple-system", "sans-serif"],
      ...
      boxShadow: {
        ...
        "card-hover": "0 20px 48px -12px rgba(10, 22, 40, 0.15)",
      ...
      animation: {
        ...
        "fade-up-delay-1": "fade-up 0.7s 0.1s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "fade-up-delay-2": "fade-up 0.7s 0.2s cubic-bezier(0.16, 1, 0.3, 1) forwards",
      },
    },
  },
