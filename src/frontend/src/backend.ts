...
export class Backend implements backendInterface {
    ...
    async getBlogArticleByTitle(arg0: string): Promise<BlogArticle> {
        if (this.processError) {
            try {
                const result = await this.actor.getBlogArticleByTitle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCaseStudyByTitle(arg0: string): Promise<CaseStudy> {
        if (this.processError) {
            try {
                const result = await this.actor.getCaseStudyByTitle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContactSubmissionByTimestamp(arg0: string): Promise<ContactSubmission> {
        if (this.processError) {
            try {
                const result = await this.actor.getContactSubmissionByTimestamp(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTestimonialByClientName(arg0: string): Promise<Testimonial> {
        if (this.processError) {
            try {
                const result = await this.actor.getTestimonialByClientName(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
